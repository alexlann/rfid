...
# Set 16 bytes of block to 0x00
data = bytearray(16)
data[0:16] = b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"

# A Deeper Understanding (ADU)
# Set 16 bytes of block to 0x01
# data = bytearray(16)
# data[0:16] = b"\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"

# Puberty2 (PB2)
# Set 16 bytes of block to 0x02
# data = bytearray(16)
# data[0:16] = b"\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
